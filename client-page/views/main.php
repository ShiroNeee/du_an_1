    ...
    <header>
        <div class="banner-content">
            <div class="image-section">
                <div class="slider">
                    <img src="../client-page/images/banner.jpg" class="slide active" />
                    <img src="../client-page/images/banner-2.jpg" class="slide" />
                    <img src="../client-page/images/banner-3.jpg" class="slide" />
                </div>
    ...
    <section class="categories">
        <div class="container">
            ...
            <div class="category-list">
                <a href="#"><div class="category-item"><img src="../client-page/images/cate-2.png" /></div></a>
    ...
    <section class="products">
        <div class="container">
            ...
            <div class="product-list">
                <!-- Simplified repeated product items -->
